...
class WebViewExampleTV extends StatefulWidget {
  const WebViewExampleTV(
      {Key? key, required this.id, required this.season, required this.episode})
      : super(key: key);
...
class WebViewExampleTVState extends State<WebViewExampleTV> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FutureBuilder(
        future:
            ApiService().getTVimbdid(widget.id, widget.season, widget.episode),
